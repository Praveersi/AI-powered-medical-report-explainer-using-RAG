...
class AnalysisResult(BaseModel):
    ...
    # Append these to the bottom of backend/app/models/schemas.py

class QueryRequest(BaseModel):
    doc_id: str = Field(..., description="The ID of the document you want to ask a question about.")
    question: str = Field(..., description="The follow-up question about your medical report.")

class QueryResponse(BaseModel):
    answer: str = Field(..., description="The plain-English answer generated by the LLM based on report context.")
    sources: List[str] = Field(default=[], description="The text chunks from the medical report used to answer the question.")